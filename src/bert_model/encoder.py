...
class Encoder(nn.Module):
    def __init__(self, vocab_size, seq_len, num_token_types, num_layers, embedding_dim, num_attention_heads, expansion_factor = 4, device='cpu'):
        super().__init__()
        self.embedding_layer = BertEmbeddingLayer(vocab_size, seq_len, embedding_dim, num_token_types, device=device)
